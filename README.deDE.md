...
Für die lokale Entwicklung stellen Sie sicher, dass Go 1.27+ installiert ist, dann:
...
**Unterstützte Passwort-Algorithmen:** `plaintext` (nur lokal) und `bcrypt`; MD5 und ungesalzenes SHA-512 werden abgelehnt
