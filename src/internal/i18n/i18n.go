...
func init() {
	...
	bundle.AddTranslations(kit.LangEN, map[string]string{
		...
		"error.invalid_phone_format":    "Invalid phone number. Please enter digits only (e.g. 11 digits for Chinese mobile).",
		...
		"error.totp_not_enrolled":                        "This account has not bound TOTP yet. Please sign in with verification code first, then bind TOTP in settings.",
		"error.rate_limited_retry":                       "Too many requests. Please try again later.",
		"error.login_sms_disabled":                       "SMS login is disabled.",
		"error.login_email_disabled":                     "Email login is disabled.",
	...
	bundle.AddTranslations(kit.LangZH, map[string]string{
		...
		"error.invalid_phone_format":    "手机号格式无效，请输入纯数字（如 11 位中国大陆手机号）。",
		...
		"error.totp_not_enrolled":                        "该账号尚未绑定 TOTP，请先使用验证码登录，再在设置中绑定 TOTP",
		"error.rate_limited_retry":                       "请求过于频繁，请稍后重试",
		"error.login_sms_disabled":                       "短信登录已禁用",
		"error.login_email_disabled":                     "邮箱登录已禁用",
	...
	bundle.AddTranslations(kit.LangFR, map[string]string{
		...
		"error.invalid_phone_format":    "Numéro de téléphone invalide. Veuillez n'entrer que des chiffres.",
		...
		"error.totp_not_enrolled":                        "Ce compte n'a pas encore lié TOTP. Veuillez vous connecter avec le code de vérification, puis lier TOTP dans les paramètres.",
		"error.rate_limited_retry":                       "Trop de demandes. Veuillez réessayer plus tard.",
		"error.login_sms_disabled":                       "La connexion par SMS est désactivée.",
		"error.login_email_disabled":                     "La connexion par e-mail est désactivée.",
		"error.send_verify_code_failed":                  "Échec de l'envoi du code de vérification",
	...
	bundle.AddTranslations(kit.LangIT, map[string]string{
		...
		"error.invalid_phone_format":    "Numero di telefono non valido. Inserire solo cifre.",
		...
		"error.totp_not_enrolled":                        "Questo account non ha ancora collegato TOTP. Accedi con il codice di verifica, quindi collega TOTP nelle impostazioni.",
		"error.rate_limited_retry":                       "Troppe richieste. Si prega di riprovare più tardi.",
		"error.login_sms_disabled":                       "Accesso tramite SMS disabilitato.",
		"error.login_email_disabled":                     "Accesso tramite e-mail disabilitato.",
		"error.send_verify_code_failed":                  "Invio del codice di verifica non riuscito",
	...
	bundle.AddTranslations(kit.LangJA, map[string]string{
		...
		"error.invalid_phone_format":    "電話番号の形式が無効です。数字のみ入力してください。",
		...
		"error.totp_not_enrolled":                        "このアカウントはまだTOTPをバインドしていません。確認コードでログインしてから、設定でTOTPをバインドしてください。",
		"error.rate_limited_retry":                       "リクエストが多すぎます。しばらくしてから再試行してください。",
		"error.login_sms_disabled":                       "SMS ログインは無効です。",
		"error.login_email_disabled":                     "メールログインは無効です。",
		"error.send_verify_code_failed":                  "確認コードの送信に失敗しました",
	...
	bundle.AddTranslations(kit.LangDE, map[string]string{
		...
		"error.invalid_phone_format":    "Ungültige Telefonnummer. Bitte nur Ziffern eingeben.",
		...
		"error.totp_not_enrolled":                        "Dieses Konto hat TOTP noch nicht gebunden. Bitte melden Sie sich zuerst mit dem Bestätigungscode an und binden Sie TOTP in den Einstellungen.",
		"error.rate_limited_retry":                       "Zu viele Anfragen. Bitte versuchen Sie es später erneut.",
		"error.login_sms_disabled":                       "SMS-Anmeldung ist deaktiviert.",
		"error.login_email_disabled":                     "E-Mail-Anmeldung ist deaktiviert.",
		"error.send_verify_code_failed":                  "Senden des Bestätigungscodes fehlgeschlagen",
	...
	bundle.AddTranslations(kit.LangKO, map[string]string{
		...
		"error.invalid_phone_format":    "잘못된 전화번호 형식입니다. 숫자만 입력하세요.",
		...
		"error.totp_not_enrolled":                        "이 계정은 아직 TOTP를 바인딩하지 않았습니다. 먼저 인증 코드로 로그인한 후 설정에서 TOTP를 바인딩하세요.",
		"error.rate_limited_retry":                       "요청이 너무 많습니다. 나중에 다시 시도하세요.",
		"error.login_sms_disabled":                       "SMS 로그인이 비활성화되었습니다.",
		"error.login_email_disabled":                     "이메일 로그인이 비활성화되었습니다.",
		"error.send_verify_code_failed":                  "인증 코드 전송에 실패했습니다",
